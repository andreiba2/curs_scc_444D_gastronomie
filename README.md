...
├── imagini/                          # Capturi de ecran pentru documentație
├── Dockerfile                        # Configurare imagine Docker
├── Jenkinsfile                       # Pipeline declarativ CI/CD
